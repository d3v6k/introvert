...
**Version:** 0.27.0 | **Status:** Production Beta | **Last Updated:** 2026-07-04
...
## Latest Release: v54 — VPN Resilience & UI Polish

- **VPN Connectivity Hardening** — Automatic tunnel stale detection and force-reset when VPN blocks WebSocket connections
- **Kliphy GIF Integration** — Search and send GIFs with "Powered by KLIPY" attribution
- **Group Chat Reactions** — Reactions now properly display for all messages and attachments
- **External Messenger Fixes** — WhatsApp/Telegram WebViews now scroll properly, login detection skips setup guide for activated accounts
