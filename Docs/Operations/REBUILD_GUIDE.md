...
1.  **$INTR Requirement:** You need 2,000,000 $INTR tokens to register as an RBN operator. These are bonded into the PDA escrow vault via the `introvert-registry` Anchor program.
...
5.  **On-Chain Registration:** The daemon interacts with the Anchor registry program to lock your 2,000,000 $INTR and declare your multiaddress. Clients will discover your RBN automatically via Solana RPC queries — no hardcoded IP lists needed.
