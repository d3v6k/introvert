...
| Symbol | $INTR |
| Mint Address | `EAXT8h2qTtS5RPfAPX3qpbn6b99bqKfNwLKyqZp9ZZPf` |
...
## 5.1 DynamicPromoStack (Customizable Campaign Layer)
...
**Campaign Types:**
- CommunityThemeVote — Daily theme competitions
- EarlyAdopterBonus — Early user onboarding
- DeveloperHackathonYield — Developer bounties
- DynamicBonusCampaign — Custom promotions
...
- Runtime adjustments without rebuilds
- Referral pool always protected
