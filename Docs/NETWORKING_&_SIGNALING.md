...
│
▼
[ Parse Registered RBN List ]   ──► Filter: Balance >= 2M $INTR & Active = true
│
▼
...
4. The swarm manager filters out entries that lack an active status or fall below the mandatory **2,000,000 $INTR** stake requirement.
